...
//            CombatLoaderSubsystem = new CombatLoaderSubsystem("Missile Cargo", "Missile Stockpile");
//
...
//                    Builder.AppendLine("3 - TOGGLE AUTOFIRE");
...
//                    for (int i = 1; i < 9; i++)
//                    {
//                        Builder.Append(i <= numTorpsLoaded ? "^" : " ");
//                    }
//                    Builder.Append(']');
//                    Builder.Append($"  {numTorpsLoaded}/8  ");
//                    Builder.AppendLine();
//                    Builder.AppendLine();
//                    for (int i = 0; i < 24; i++)
//                    {
...
//                    // 
//                    Builder.AppendLine(HostProgram.TorpedoSubsystem.TorpedoTubeGroups["SM"].AutoFire ? "  AUTOFIRE ON  " : "  AUTOFIRE OFF  ");
//
